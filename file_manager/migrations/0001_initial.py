    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='files', to='file_manager.filecategory')),
                ('tags', models.ManyToManyField(blank=True, related_name='files', to='file_manager.tag')),
            ],
            options={
                'verbose_name': 'Файл',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('changed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='file_versions', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('activity_type', models.CharField(choices=[('upload', 'Uploaded'), ('download', 'Downloaded'), ('view', 'Viewed'), ('edit', 'Edited'), ('delete', 'Deleted'), ('share', 'Shared'), ('comment', 'Commented'), ('version_create', 'Created new version'), ('favorite_add', 'Added to favorites'), ('favorite_remove', 'Removed from favorites')], max_length=20)),
                ('description', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True)),
                ('file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities', to='file_manager.file')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='file_manage_user_id_f66d31_idx'), models.Index(fields=['activity_type', '-created_at'], name='file_manage_activit_736b0d_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='file',
